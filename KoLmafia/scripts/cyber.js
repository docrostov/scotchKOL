...
function main(cmd) {
    ...
    if (cmd.includes("help")) {
        ...
        printHtml("<b><p style=\"font-family:'Courier new'\"><br>=======================================</p></b><br>= ----------------------  _+^^*+_     =</p></b><br>= - S I C K------------  {       )  ( =</p></b><br>= ---- H A C K -------  { (@)    } f  =</p></b><br>= ------- B R O ------ {:;-/    (_+*- =</p></b><br>= ------------------- ( /  (    (     =</p></b><br>= -------------------  U _/     )     =</p></b><br>= --------------------  (      )  _(^ =</p></b><br>   = ------------------- (      /  (_))_ =</p></b><br>= -------------------(     ,/    (^)) =</p></b><br>= ------------------- *+__+*       (_ =</p></b><br>=======================================</p></b><br>");
    }
